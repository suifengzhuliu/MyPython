...
print("用于测试的数据")
size = 100
oriTestData = values[365 * 24 + 24:365 * 24 + 24+size, 0]
print(oriTestData)
...
# fit network
history = model.fit(train_X, train_y, epochs=30, batch_size=240, validation_data=(test_X, test_y), verbose=2, shuffle=False)
# plot history
